...
# inspired by: https://github.com/Werkov/PySide6/blob/master/examples/widgets/analogclock.py
...
try:
    ...
    print("--ERROR-- Cannot import pyside 6: \n", e)
    exit()
...
class AnalogGaugeWidget(QWidget):
    ...
    def draw_big_needle_center_point(self, diameter=30):
        painter = QPainter(self)
        # painter.setRenderHint(QtWidgets.QPainter.HighQualityAntialiasing)
        painter.setRenderHint(QPainter.Antialiasing)
...
if __name__ == "__main__":
    ...
    class mainclass:
        ...
        def __init__(self):
            ...
            from gauge_demo.analoggaugewidget_demo_ui import Ui_MainWindow
